  ...
  return (
    ...
    <div className="flex flex-col justify-center items-center h-screen bg-gray-100 text-center p-4">
      <div className="animate-bounce">
        <svg className="mx-auto w-64 h-64" version="1.0" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 500 500" preserveAspectRatio="xMidYMid meet">
      ...
      <h1 className="text-5xl font-bold text-gray-800 mt-8 animate-pulse">404 - Page Not Found</h1>
      <p className="text-lg text-gray-600 mt-4">Sorry, the page you are looking for doesn't exist.</p>
      <Link to="/" className="mt-6 text-blue-600 hover:underline text-lg">
        Go back to Home
      </Link>
    </div></>
  );
